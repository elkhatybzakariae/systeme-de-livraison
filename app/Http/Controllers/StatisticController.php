...
class StatisticController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // dd($facturesPaye);
        $facturesEnregistre = Facture::select(
            'factures.status',
            DB::raw('COUNT(DISTINCT factures.id_F) AS factures_count'),
            DB::raw('COUNT(colis.id) AS colis_count'),
            DB::raw('SUM(colis.prix) AS prix_total'),
        ...
        $facturesBrouillon = Facture::select(
            'factures.status',
            DB::raw('COUNT(DISTINCT factures.id_F) AS factures_count'),
            DB::raw('COUNT(colis.id) AS colis_count'),
            DB::raw('SUM(colis.prix) AS prix_total'),
        ...
        $livBonAttent = BonPaymentLivreur::select(
        ...
        // dd($livBonAttent);
        $livBonPaye = BonPaymentLivreur::select(
            'bon_payment_livreurs.status',
            DB::raw('COUNT(bon_payment_livreurs.id_BPL) AS bons_count'),
            DB::raw('COUNT(colis.id) AS colis_count'),
            DB::raw('SUM(colis.prix) AS prix_total'),
        ...
        $zoneBonAttent = BonPaymentZone::select(
        ...
        $zoneBonPaye = BonPaymentZone::select(
            'bon_payment_zones.status',
            DB::raw('COUNT(bon_payment_zones.id_BPZ) AS bons_count'),
            DB::raw('COUNT(colis.id) AS colis_count'),
            DB::raw('SUM(colis.prix) AS prix_total'),
        ...
        return view('pages.admin.statistic.index', compact(
            'breads',
            'facturesBrouillon',
            'facturesEnregistre',
            'facturesPaye',
    ...
    public function zone(Request $request)
    {
        ...
        return view('pages.admin.statistic.zone', compact(
            'breads',
            'zoneBonAttent',
            'zoneBonPaye',
            'zoneBonTotal',
    ...
    public function livreur(Request $request)
    {
        ...
        return view('pages.admin.statistic.livreur', compact(
            'breads',
            'colisStatus',
            'livs',
            'livBonAttent',
    ...
    public function client(Request $request)
    {
        ...
        return view('pages.admin.statistic.client', compact(
            'breads',
            'facturesBrouillon',
            'facturesEnregistre',
            'facturesPaye',
