...
class BonLivraisonController extends Controller
{
    ...
    public function generateStikers() {
        ...
        $data = [
          'date' => '2024-05-04',
          'vendeur' => 'Carol Thompson ( +1 (919) 584-7463 )',
          'destinataire' => 'Actual Name', // Replace with actual data
          'telephone' => 'Actual Phone Number', // Replace with actual data
          'adresse' => 'Actual Address', // Replace with actual data
          'commentaire' => 'Optional comment', // Replace with actual data (optional)
          'produit' => 'Product details', // Replace with actual data
          // ... other data for the tables
        ];
        ...
        $html = '<!DOCTYPE html>
          ...
          <body>
            <div class="sticker m-4">
              <div class="row">
                <div class="col-8">
                  ...
                  <div class="info">
                    <span>Vendeur:</span> ' . $data['vendeur'] . '
                  </div>
            ...
            <div class="barcode">
              <img src="data:image/svg+xml;base64," alt="Bare HTML Code" />
