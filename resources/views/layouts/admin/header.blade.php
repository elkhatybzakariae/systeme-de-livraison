                ...
                <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="d-flex flex-column">
                                    <div class="fw-bold  d-flex align-items-center fs-5">{{ session('admin')['nomcomplet'] }}
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{ session('admin')['isAdmin'] ?'Admin':'User'}}</span></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ session('admin')['email'] }}</a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
                        ...
                        <div class="menu-item px-5">
                            ...
                            <a href="{{route('admin.signout')}}" class="menu-link text-hover-danger  px-5">Sign Out</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
