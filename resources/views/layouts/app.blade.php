...
<html dir="ws_config_dir" lang="ws_config_lang">
     <head>
	 		<style>
			 :root {
    --main-color: #2e7d32;    /* Main green color */
    --second-color: #388e3c;  /* Lighter shade of green */
    --third-color: #43a047;   /* Lightest shade of green */
    --fourth-color: #1b5e20;  /* Darker shade of green */
    --fifth-color: #1b5e20;   /* Another darker shade of green */
    --hover-color: #388e3c;   /* Hover color, lighter shade of green */
    --focus-color: #2e7d32;   /* Focus color, main green color */
}
