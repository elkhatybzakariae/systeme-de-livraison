...
<head>
    ...
    <!-- keywords -->
    <meta name="keywords"
        content="livraison à domicile maroc,livraison à domicile,livraison Maroc.">
    <!-- favicon -->
    <meta name="title" content="ELM EXPRESS" />
    <meta property="og:title"
        content="ELM EXPRESS" />
    <meta property="og:description"
        content="ELM EXPRESS" />
    <meta property="og:image" content="{{ asset('storage/images/l.png') }}" />
