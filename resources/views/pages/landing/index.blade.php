            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 p-0">
                    <div class="single-offer">
                        ...
                        <h3>Ramassage</h3>
                        <p>Le ramassage est un service mis en place par la société vitex afin de faciliter au maximum votre
                ...
                <div class="col-lg-3 col-sm-6 p-0">
                    <div class="single-offer">
                        ...
                        <h3>Expédition</h3>
                        <p>L’équipe de vitex assure l’acheminement de vos colis à votre destinataire contre un accusé de
                            réception.</p>
                        </br>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="about-content">
                        ...
                        <h2>vitex</h2>
                        <p>Vitex est la nouvelle solution d'expédition pour gérer vos livraisons en ligne. Donnez à votre
                            entreprise en ligne un avantage concurrentiel grâce aux solutions de livraison sur mesure de
                            commerce électronique de Vitex. La société Vitex assure l’expédition, l’arrivage, le ramassage,
                    ...
                    <div class="single-service">
                        <div class="service-content-wrap">
                            ...
                            <p>Qu'ils soient transactionnels ou postaux, les systèmes d'insertion hautes performances de
                                vitex offrent un traitement des documents sécurisé, efficace et flexible.</p>
                        </div>
                        <div class="service-heading">
                            <h3>Insertion</h3>
