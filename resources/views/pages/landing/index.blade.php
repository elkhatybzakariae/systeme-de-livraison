		...
		0600000000
			...
			<div class="navbar-area">
				...
				<div class="mobile-nav">
					...
					<a href="https://cdn.vitex.ma/" class="logo">

						<img class="logo-header"src="https://cdn.vitex.ma/images/front/header-logo.png" alt="Logo">
					</a>
				</div>
				...
				<div class="main-nav" style="background-color:var(--main-color)">
					<nav class="navbar navbar-expand-md navbar-light">
						<div class="container">
							<a class="navbar-brand"  href="https://cdn.vitex.ma/">
								<img class="logo-header" src="https://cdn.vitex.ma/images/front/header-logo.png" alt="Logo">
							</a>
							<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
								<ul class="navbar-nav m-auto">
										<li class="nav-item">
											<a href="http://vitex.ma/" class="nav-link dropdown-toggle ">
																							Accueil
											</a>
									
										</li>
										<li class="nav-item">
											<a href="http://vitex.ma/#services-section" class="nav-link dropdown-toggle">
											Services
																							</a>
										</li>
										<li class="nav-item">
											<a href="tarifs" class="nav-link dropdown-toggle">
											Tarifs
											</a>
										</li>
										<li class="nav-item">
										<a href="http://vitex.ma/#avantages-section" class="nav-link dropdown-toggle">
										Avantages 
										</a>
									</li>
										...
										<li class="nav-item">
											<a href="http://vitex.ma/#contact-section" class="nav-link">Contact</a>
										</li>
										
										<li class="nav-item">
											<a href="http://vitex.ma/clients//register" class="nav-link">Devenir client</a>
										</li>
										<li class="nav-item">
											<a href="http://vitex.ma/clients/" class="nav-link">Espace client</a>
										</li>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6">
						<div class="single-widget">
							...
							<p>La société Vitex  assure l’expédition, l’arrivage, le ramassage, la livraison, le retour des fonds,la confirmation, le stock , la gestion documentaire et propose à chaque client professionnel ou particulier une offre de prestation complète, variée et optimale grâce à une expérience riche et professionnelle sur le marché de la messagerie nationale..</p>
...
<footer class="footer-bottom-area footer-bottom-area-four">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6">
						<div class="single-widget-bottom">
							<p>Copyright <i class="bx bx-copyright"></i> 2024. All rights reserved</p>
						</div>
					</div>
				</div>
			</div>
    ...
    {{-- <script src="https://cdn.vitex.ma/assets/main-page/js/main.js"></script> --}}
