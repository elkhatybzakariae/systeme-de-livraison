        ...
        <div class="form-group row">
            <div class="col-md-4">
                <select class="form-control" id="date_filter" name="date_filter" onchange="this.form.submit()">
                    ...
                    <option value="last_7_days" {{ request('date_filter') == 'last_7_days' ? 'selected' : '' }}>7 derniers
                        jours</option>
                    <option value="last_30_days" {{ request('date_filter') == 'last_30_days' ? 'selected' : '' }}>30
                        derniers jours</option>
                    <option value="this_month" {{ request('date_filter') == 'this_month' ? 'selected' : '' }}>Ce mois
                    </option>
                    <option value="last_month" {{ request('date_filter') == 'last_month' ? 'selected' : '' }}>Le mois
                        dernier</option>
                    <option value="custom_range" {{ request('date_filter') == 'custom_range' ? 'selected' : '' }}>Plage
                        personnalisée</option>
                </select>
            </div>
            <div class="col-md-3">
                <input type="date" class="form-control" name="start_date" placeholder="Date de début"
                    value="{{ request('start_date') }}" {{ request('date_filter') != 'custom_range' ? 'disabled' : '' }}>
            </div>
            <div class="col-md-3">
                <input type="date" class="form-control" name="end_date" placeholder="Date de fin"
                    value="{{ request('end_date') }}" {{ request('date_filter') != 'custom_range' ? 'disabled' : '' }}>
            </div>
        </div>
    </form>
@endsection
  ...
  @endforeach --}}
                    ...
                    <div class="col-8">
                        ...
                        <select name="client_id" id="client_id" class="form-control ">
                            ...
                            @foreach ($clients as $client)
                                <option value="{{ $client->id_Cl }}"
                                    {{ request('client_id') == $client->id_Cl ? 'selected' : '' }}>
                                    {{ $client->nomcomplet }}
                                    <!-- Adjust attribute to match your client's name attribute -->
                                </option>
                            @endforeach
                        </select>
                    </div>
        ...
        <div class="row  gap-5">
            ...
            <div class="card col-md-12 mt-5">
                <div class="card-header">
                    ...
                    <h4 class="card-title">Colis Statistics ( {{ $colis }} )</h4>
                </div>
                <div class="card-body">
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title">Bon Livraisons( {{ $liv }} ) </h4>
                </div>
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header  d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title "> Bon Envois ( {{ $env }} )</h4>
                </div>
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header  d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title "> Bon Distribution ( {{ $dis }} )</h4>
                </div>
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header  d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title "> Bon payment livreur ( {{ $payLiv }} )</h4>
                </div>
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header  d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title "> Bon Retour Client ( {{ $retourC }} )</h4>
                </div>
            ...
            <div class="card col-md-5 mt-5 mx-5">
                <div class="card-header  d-flex justify-content-center align-items-center">
                    ...
                    <h4 class="card-title "> Bon Retour Livreur ( {{ $retourL }} )</h4>
                </div>
    ...
    <script>
        ...
        if ({{ count($countsBE) }} != 0) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var ctx = document.getElementById('bonEnvoiChart').getContext('2d');
                var bonLivraisonsChart = new Chart(ctx, {
                    type: 'doughnut',
                    data: {
                        labels: @json($statusesBE),
                        datasets: [{
        ...
        if ({{ count($countsBD) }} != 0) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var ctx = document.getElementById('bonDisChart').getContext('2d');
                var bonLivraisonsChart = new Chart(ctx, {
                    type: 'doughnut',
                    data: {
        ...
        if ({{ count($countsBPL) }} != 0) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var ctx = document.getElementById('bonPLChart').getContext('2d');
                var bonLivraisonsChart = new Chart(ctx, {
                    type: 'doughnut',
                    data: {
        ...
        if ({{ count($countsBRC) }} != 0) {
            document.addEventListener('DOMContentLoaded', function() {
                var ctx = document.getElementById('bonRCChart').getContext('2d');
                var bonLivraisonsChart = new Chart(ctx, {
                    type: 'doughnut',
                    data: {
        ...
        if ({{ count($countsBRL) }} != 0) {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                var ctx = document.getElementById('bonRLChart').getContext('2d');
                var bonLivraisonsChart = new Chart(ctx, {
                    type: 'doughnut',
                    data: {
