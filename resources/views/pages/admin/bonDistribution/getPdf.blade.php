...
<body>
  ...
  <table>
    <tr>
      <td style="width: 50%">
        ...
        <div class="" ><img src="{{ asset('storage/images/logo.png') }}" alt=""></div>
      </td>
      <td style="width: 50%">
        <div class="">
  ...
  <table class="table">
    <tr style="height:15.6pt; -aw-height-rule:exactly">
        <td><p style="font-size:8pt"><span style="font-family:Calibri">Code d envoi</span></p>        </td>
        <td><p style="font-size:8pt"><span style="font-family:Calibri">Telephone</span></p>        </td>
        <td ><p style="font-size:8pt"><span style="font-family:Calibri">Ville</span></p>        </td>
        <td><p style="font-size:8pt"><span style="font-family:Calibri">Crbt</span></p>       </td>
    </tr>
