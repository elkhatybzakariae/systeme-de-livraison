...
@section('breads')
    ...
    @foreach ($remarques as $remarque)
        <div class="alert @if ($remarque->type == 'Urgence') alert-danger
                    ...
                    <div class="card-body d-flex justify-content-between align-items">
                        ...
                        <span class="ms-3 text-gray-700 parent-hover-primary fs-6 fw-bold">
                            <div class="d-flex flex-column">
                                ...
                                {{-- <span class="me-2 text-end">{{ $counts }}</span> --}}
                            </div>
                        </span>
                    </div>
                </a>
      ...
      @endif --}}
                    ...
                    <script>
                        document.addEventListener('DOMContentLoaded', function() {
                            // Colis Chart
                            var ctxColis = document.getElementById('colisChart').getContext('2d');
                            var colisChart = new Chart(ctxColis, {
                                type: 'bar',
                                data: {
                                    labels: @json(array_keys($distributionStatistics)),
                                    datasets: [{
                                        label: 'Colis Count',
                                        data: @json(array_values($distributionStatistics)),
                            ...
                            // Bon Livraisons Chart
                            var ctxBonLivraisons = document.getElementById('bonLivraisonsChart').getContext('2d');
                            var bonLivraisonsChart = new Chart(ctxBonLivraisons, {
                                type: 'doughnut',
                                data: {
                                    labels: @json(array_keys($retourStatistics)),
                                    datasets: [{
                                        label: 'Bon Livraisons Count',
                                        data: @json(array_values($retourStatistics)),
                                        backgroundColor: [
                                            'rgba(255, 99, 132, 0.2)',
                                            'rgba(54, 162, 235, 0.2)',
                                            'rgba(255, 206, 86, 0.2)',
