          ...
          <form method="POST" action="{{ route('colis.store') }}">
            ...
            <div class="form-group row">
              ...
              <div class="form-group col-md-6 ">
                ...
                <div class="">
                    <input id="prix" type="number" class="form-control @error('prix') is-invalid @enderror" name="prix" value="{{ old('prix') }}" required>
                    <x-error field='prix' />
                </div>
            </div>
              <div class="form-group col-md-6 ">
                  ...
                  <div class="">
                      <textarea name="adresse" class="form-control @error('prix') is-invalid @enderror" id="" cols="" rows="1">{{ old('prix') }}</textarea>
                      <x-error field='adresse' />
                  </div>
              </div>
              <div class="form-group col-md-6 ">
                  <label for="zone" class="col-md-4 col-form-label text-md-right">{{ __('commentaire') }}</label>
            ...
            <div class="form-group col-md-6 ">
              ...
              <div class="">
                  <select id="zone" class="form-control @error('zone') is-invalid @enderror" name="zone" >
